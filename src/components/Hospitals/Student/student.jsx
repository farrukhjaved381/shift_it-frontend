...
const StudentsRotationCompletions = () => {
  ...
  const filterOptions = ['All Rotations', 'Nursing', 'Radiology', 'Surgery', 'Cardiology', 'Pediatrics', 'Psychiatry'];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <p className="text-sm sm:text-base text-gray-600">
            View and manage students who completed clinical rotations
          </p>
        </div>
              ...
              <div className="text-center py-8">
                ...
                <p className="text-sm text-gray-500">
                  {searchTerm || selectedFilter !== "All Rotations"
                    ...
                    : "No clinical rotation completions have been recorded yet."}
                </p>
              </div>
            )}
          </div>
...
export default StudentsRotationCompletions;